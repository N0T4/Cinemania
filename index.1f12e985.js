...
</div>`).join("");t.innerHTML=o}(_,F),function(){let e=document.querySelector(".students-overlay");e.classList.toggle("visually-hidden"),function(e){let t=document.querySelector(".students-modal-close-btn");t.addEventListener("click",()=>{e.classList.add("visually-hidden")})}(e)}()});
//# sourceMappingURL=index.1f12e985.js.map
