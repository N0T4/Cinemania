...
</div>`).join("");t.innerHTML=o}(k,S),function(){let e=document.querySelector(".students-overlay");e.classList.toggle("visually-hidden"),_.play(),document.body.style.overflow="hidden",function(e){let t=document.querySelector(".students-modal-close-btn");t.addEventListener("click",()=>{e.classList.add("visually-hidden"),_.pause(),document.body.style.overflow="scroll"})}(e)}()});
//# sourceMappingURL=index.f3f60341.js.map
