...
</div>`).join(""),E.innerHTML=t,function(){let e=document.querySelector(".students-overlay");e.classList.toggle("visually-hidden"),_.play(),function(e){let t=document.querySelector(".students-modal-close-btn");t.addEventListener("click",()=>{e.classList.add("visually-hidden"),_.pause()})}(e)}()})}();
//# sourceMappingURL=index.0c6c0022.js.map
